...
This release adds the commit to update the changelog information and therefore features for this release are found in the section for the release candidate 1 for 3.4.0 information listed below.
